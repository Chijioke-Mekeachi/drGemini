...
const CreditPackage = ({ amount, nairaAmount, credits, description, popular, onSelect, loading, duration = "1 Month" }) => (
  <div className={`relative bg-white rounded-2xl border-2 transition-all duration-300 transform hover:scale-105 ${
    ...
    >
      <div className="mb-4">
        <h3 className="text-5xl font-bold text-brand-blue-dark mb-2">${amount?.toLocaleString()}</h3>
      ...
      <div className="space-y-2 mb-6 text-left">
        ...
        <div className="flex items-center gap-2 text-green-600 font-semibold">
          <Zap size={16} />
          <span>Full Access to CareWave AI</span>
        </div>
      </div>
  ...
  const packages = [
    {
      ...
      nairaAmount: 5000,
      credits: 50,
      description: "Perfect for getting started with CareWave AI",
      popular: false,
      duration: "1 Month"
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-brand-gray-dark max-w-2xl mx-auto leading-relaxed">
            Get unlimited access to CareWave AI with our subscription plans. 
        ...
        <div className="text-center mt-12">
          <p className="text-brand-gray-dark text-sm">
            Need help with payment? Contact our support team at support@CareWave AI.com
          </p>
        </div>
      </div>
